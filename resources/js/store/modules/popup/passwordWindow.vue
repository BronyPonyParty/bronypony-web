                ...
                <div class="col">
                    <div v-click-outside="close">
                        ...
                        <div class="card-body bg-white text-black" style="border-radius: 0 0 5px 5px">
                            <input type="password" class="form-control form-control-lg outline-text" placeholder="Введите пароль" ref="password" @keyup.enter="getAccess">

                            <div class="button" style="text-align: right">
                                <button class="btn yes-btn text-white" style="border: none; box-shadow: inherit;" @click="getAccess"><strong>Подтвердить</strong></button>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        getAccess() {
            ...
            this.$store.dispatch('user/confirmPassword', password);
        }
    }
}
</script>
